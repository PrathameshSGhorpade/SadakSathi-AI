...
- **Planned canonical location**: `SadakSathi-AI/apps/authority-dashboard`
...
[Yolov8 pothole detection model](https://huggingface.co/PrathameshSGhorpade/pothole-detection-yolov8)
...
docker run --gpus all -p 8000:8000 \
  ...
  -e MODEL_PATH=https://huggingface.co/PrathameshSGhorpade/pothole-detection-yolov8/resolve/main/best.pt \
  pothole-api-gpu
```
...
## Support!
Support the repository by joining the [stargazers](https://github.com/PrathameshSGhorpade/SadakSathi-AI/stargazers) for this repo ⭐

### Created & Maintained By

[PrathameshSGhorpade](https://github.com/PrathameshSGhorpade)
